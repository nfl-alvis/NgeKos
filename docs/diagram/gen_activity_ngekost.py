...
PAGES = [
    dict(name="1. Autentikasi Owner (Register & Login)",
        ...
        ("r10-0", "r12-0", "data sesuai"),
        ("r11-0", "r5-0", "tidak", "side"),
        ("r11-0", "r12-0", "ya"),
        ("r12-0", "r13-0", ""),
        ("r12-0", "r13-1", ""),
        ("r13-0", "r14-0", ""),
    ...
    dict(name="9. Webhook Midtrans & Konversi Guest → Tenant",
        ...
        [("action", "tolak / abaikan\n(401 atau 200 duplikat)", 1)],
        [("fork", "", 1)],
        [("action", "memasukkan data\nke database", 1),
    ...
    dict(name="11. Verifikasi Property (Admin)",
        ...
        [("action", "set verified=true", 1)],
        [("action", "set REJECTED\n+ alasan", 1)],
        [("fork", "", 1)],
        [("action", "memasukkan data\nke database", 1),
         ("action", "tampilkan hasil &\nkirim notifikasi", 1)],
        [("join", "", 1)],
        [("action", "lihat hasil\ndi halaman riwayat", 0)],
        [("end", "", 1)],
    ], edges=[
        ("r0-0", "r1-0", ""),
        ("r1-0", "r2-0", ""),
