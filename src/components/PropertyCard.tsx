...
export default async function PropertyCard({ property }: { property: Property }) {
  ...
  return (
    <Link
      ...
      className="group flex h-full flex-col border-t border-l border-nk-border bg-nk-bg p-6 transition-colors hover:bg-nk-section focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-nk-accent"
    >
