      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div className="flex flex-col gap-6 lg:col-span-2">
          ...
          <DashSection title={t("identity")} bodyClass="p-4 sm:p-6">
            ...
            <div className="mt-6 border-t border-nk-border pt-5">
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  <Label htmlFor="pf-name" className="text-xs text-nk-text-muted">
                    {t("name")}
                  </Label>
                  <Input id="pf-name" defaultValue={userProfile.name} className="mt-1.5 h-11 md:h-9" />
                </div>
                <div>
                  <Label htmlFor="pf-phone" className="text-xs text-nk-text-muted">
                    {t("phone")}
                  </Label>
                  <Input id="pf-phone" defaultValue={userProfile.phone} className="mt-1.5 h-11 md:h-9" />
                </div>
                <div>
                  ...
                  <Input
                    id="pf-birth"
                    defaultValue={`${userProfile.birthPlaceId}, 17 April 1999`}
                ...
                <div>
                  ...
                  <Input id="pf-occupation" defaultValue={userProfile.occupationId} className="mt-1.5 h-11 md:h-9" />
                </div>
              </div>
              <div className="mt-5 flex items-center gap-3">
                <button
                  ...
                  className="bg-nk-accent px-5 py-2.5 text-sm font-medium text-nk-text-inverse transition-opacity hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-nk-accent"
                >
                  {t("save")}
                </button>
                {saved && <span role="status" className="text-sm text-[#2F6B3C]">{t("saved")}</span>}
              </div>
            </div>
          </DashSection>
