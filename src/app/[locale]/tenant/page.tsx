...
// akhir perjanjian aktif ("Agu 2026 - Agu 2027") — demo date konstan
const ACTIVE_AGREEMENT_END = "2027-08-31";
...
export default function TenantDashboardPage() {
  ...
  const quickActions = [
    { key: "qaBookings", href: "/bookings", icon: CalendarClock },
    { key: "qaInvoices", href: "#tagihan", icon: Receipt },
          ...
          <section id="tagihan" className="flex flex-col gap-1 overflow-hidden rounded-xl ring-1 ring-foreground/10 bg-nk-section">
            <div className="flex items-center justify-between px-4 pb-1 pt-3">
              ...
              <span className="text-xs text-nk-text-muted">
                {t("paidCount", { paid: myInvoices.filter((i) => i.status === "lunas").length, total: myInvoices.length })}
              </span>
            </div>
